...
export const ProjectDesktop = ({project}) => {
  ...
  const {title, description, image1, image2, technologies, web, repository, figma} = project;
  ...
  return (
    <div className="bg-tertiary/90 dark:bg-secondary/90 rounded-2xl p-4 flex flex-col items-center justify-evenly hover:bg-tertiary hover:dark:bg-secondary">
            ...
            <div className='mt-5 relative h-44 md:h-52 w-64 md:w-full lg:w-4/5 mx-auto'>
              <img src={image2} alt={title + "2"} className='h-36 md:h-44 absolute top-1 left-[18%] sm:left-28 md:left-20 rotate-3 shadow-xl z-10 duration-150 hover:scale-110 hover:z-30' />
              <img src={image1} alt={title + "1"} className='h-36 md:h-44 absolute top-0 -left-2 shadow-xl z-20 duration-150 hover:scale-110' />
            </div>
