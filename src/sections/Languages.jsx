    ...
    <section className='max-w-4xl mx-3 md:mt-3 md:mx-auto grid grid-cols-1 md:grid-cols-2 gap-y-3 md:gap-x-3'>
      ...
      <div className='bg-lightbox dark:bg-darkbox rounded-2xl p-4 text-white'>
        ...
        <ul className='mt-4 flex flex-wrap gap-4'>
          ...
          <li className='flex flex-col items-center text-sm font-medium'><img src={postgresqlIcon} className='h-6' /> PostgreSQL</li>
          <li className='flex flex-col items-center text-sm font-medium'><img src={swaggerIcon} className='h-6' /> Swagger</li>
          <li className='flex flex-col items-center text-sm font-medium'><img src={postmanIcon} className='h-6' /> Postman</li>
