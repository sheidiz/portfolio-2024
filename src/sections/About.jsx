...
const About = () => {
  ...
  return (
    ...
    >
      <div className="col-span-2 rounded-2xl bg-lightbox p-4 md:col-span-1">
        <h1 className="mb-1 text-2xl font-bold text-white md:text-3xl">
          Sheila Diz
        </h1>
        <h2 className="font-bold text-quaternary/80 md:text-xl">{t.title}</h2>
      ...
      <div className="col-span-2 flex h-full w-full gap-2 md:col-span-1 md:gap-3">
        ...
        <ul className="flex w-1/2 flex-col justify-between gap-y-2 md:col-span-1 md:w-1/4 md:gap-y-3">
          <li className="flex h-full w-full items-center justify-center rounded-2xl bg-lightbox p-4 text-2xl text-white dark:bg-darkbox min-[500px]:text-3xl lg:text-4xl">
