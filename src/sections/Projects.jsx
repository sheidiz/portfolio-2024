      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        {t.projects && t.projects.map((p, i) => (
          <div key={i} className="bg-tertiary/90 dark:bg-secondary/90 rounded-2xl p-4 flex flex-col items-center justify-evenly hover:bg-tertiary hover:dark:bg-secondary">
            ...
            <div className='mt-5 relative h-52 w-full lg:w-4/5 mx-auto'>
              <img src={p.image2} alt={p.title + "2"} className='h-44 absolute top-1 left-28 md:left-20 rotate-3 shadow-xl z-10 duration-150 hover:scale-110 hover:z-30' />
